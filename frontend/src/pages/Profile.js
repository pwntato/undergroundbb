...
import { Container, Typography, TextField, Box, Button, Checkbox, FormControlLabel, Alert } from '@mui/material';
  ...
  return (
    <Container maxWidth="sm">
      <Box sx={{ mt: 8, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        {updateMessage && <Alert severity="info" sx={{ mb: 2 }}>{updateMessage}</Alert>}
        <TextField
          variant="outlined"
          margin="normal"
          fullWidth
        ...
        <FormControlLabel
          ...
          label="Hidden"
        />
        <Button variant="contained" color="primary" onClick={handleUpdate} sx={{ mt: 2, mb: 4 }}>
          Update
        </Button>
